...
flow.redirect_uri = "http://127.0.0.1:8080/auth/google/callback"  # use value from config
        ...
        for single_history in download_history:
            list_history.append(
                routeResponse.singleHistory(
                    ...
                    filename=single_history.filename,
                    fileDownloadLink=single_history.file_download_link,
